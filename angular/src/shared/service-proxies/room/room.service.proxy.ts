...
import { CreateRoomDto, RoomDto, RoomDtoListResultDto, RoomDtoPagedResultDto, StudyTimeListResultDto } from './dto/room-dto';
...
export class RoomServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<RoomDto> {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<RoomDtoPagedResultDto> {
    ...
    getRoomByCurrentTenant(): Observable<RoomDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<RoomDtoListResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processRoomByCurrentTenant(response: HttpResponseBase): Observable<RoomDtoListResultDto> {
        ...
        return _observableOf<RoomDtoListResultDto>(<any>null);
    }

    getStudyTime(): Observable<StudyTimeListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStudyTime(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStudyTime(<any>response_);
                } catch (e) {
                    return <Observable<StudyTimeListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<StudyTimeListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetStudyTime(response: HttpResponseBase): Observable<StudyTimeListResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StudyTimeListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StudyTimeListResultDto>(<any>null);
    }
}

...
using SarahEducation.Sessions;
using SarahEducation.Web.Models.Account;
using SarahEducation.Web.Views.Shared.Components.TenantChange;

namespace SarahEducation.Web.Controllers
{
    public class AccountController : SarahEducationControllerBase
    {

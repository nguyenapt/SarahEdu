...
import { CreateStudentDto, StudentDto, StudentDtoPagedResultDto, StudentFeeListResultDto } from './dto/student-dto';
...
export class StudentServiceProxy {
    ...
    getFees(studentId: string): Observable<StudentFeeListResultDto> {

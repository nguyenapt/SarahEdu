...
import { CreateStudentDto, StudentDto, StudentDtoPagedResultDto, StudentFeeListResultDto, CreateStudentPaymentDto, StudentPaymentDto, StudentPaymentPagedResultDto, StudentCommentDto, CreateStudentCommentDto, StudentCommentPagedResultDto, StudentStatusPagedResultDto } from './dto/student-dto';
...
export class StudentServiceProxy {
    ...
    getStudents(): Observable<StudentDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Student/GetStudents";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStudents(<any>response_);
                } catch (e) {
                    return <Observable<StudentDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processStudents(response: HttpResponseBase): Observable<StudentDtoPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<StudentFeeListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<StudentFeeListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetFees(response: HttpResponseBase): Observable<StudentFeeListResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StudentFeeListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StudentFeeListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
     createPayment(body: CreateStudentPaymentDto | undefined): Observable<StudentPaymentDto> {
        let url_ = this.baseUrl + "/api/services/app/Student/CreatePayment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<StudentPaymentDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<StudentPaymentDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreatePayment(response: HttpResponseBase): Observable<StudentPaymentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StudentPaymentDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    updatePayment(body: StudentPaymentDto | undefined): Observable<StudentPaymentDto> {
        let url_ = this.baseUrl + "/api/services/app/Student/UpdatePayment";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdatePayment(response: HttpResponseBase): Observable<StudentPaymentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
     deletePayment(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Student/DeletePayment?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeletePayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeletePayment(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeletePayment(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
     deleteComment(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Student/DeleteComment?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
    ...
    //Get status
    getGetStudentStatusFromDateToDate(attitude: number | undefined,fromDate: string | undefined, toDate: string | undefined): Observable<StudentStatusPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/TimeSheetEntryStudent/GetTimeSheetStudentStatus?";    
        
        if (attitude !== undefined)
            url_ += "attitude=" + encodeURIComponent("" + attitude) + "&";               
        if (fromDate !== undefined)
            url_ += "fromDate=" + encodeURIComponent("" + fromDate) + "&";
        if (toDate !== undefined)
            url_ += "toDate=" + encodeURIComponent("" + toDate) + "&";               
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStudentStatusFromDateToDate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStudentStatusFromDateToDate(<any>response_);
                } catch (e) {
                    return <Observable<StudentStatusPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<StudentStatusPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetStudentStatusFromDateToDate(response: HttpResponseBase): Observable<StudentStatusPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StudentStatusPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StudentStatusPagedResultDto>(<any>null);
    }
}

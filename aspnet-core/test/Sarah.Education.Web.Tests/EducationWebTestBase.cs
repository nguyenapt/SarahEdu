...
{
    public abstract class EducationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EducationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EducationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EducationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EducationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EducationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EducationDbContext, Task<T>> func)
        {
            T result;

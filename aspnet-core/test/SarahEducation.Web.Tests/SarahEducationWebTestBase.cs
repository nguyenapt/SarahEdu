...
{
    public abstract class SarahEducationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SarahEducationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SarahEducationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SarahEducationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SarahEducationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SarahEducationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SarahEducationDbContext, Task<T>> func)
        {
            T result;

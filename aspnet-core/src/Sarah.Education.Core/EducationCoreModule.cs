...
using Sarah.Education.Localization;
using Sarah.Education.MultiTenancy;
using Sarah.Education.Timing;
...
namespace Sarah.Education
{
    ...
    public class EducationCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            EducationLocalizationConfigurer.Configure(Configuration.Localization);

            // Enable this line to create a multi-tenant application.
            Configuration.MultiTenancy.IsEnabled = EducationConsts.MultiTenancyEnabled;
